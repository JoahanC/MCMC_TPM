...
C
	...
	SAVE
      DATA              ZNS,           C1SS,          ZES/
     A                  1.19459D-5,    2.9864797D-6, .01675/
      DATA              ZNL,           C1L,           ZEL/
     A                  1.5835218D-4,  4.7968065D-7,  .05490/
...
*     ENTRANCE FOR DEEP SPACE INITIALIZATION
      ...
      ENTRY DPINIT(EQSQ,SINIQ_IN,COSIQ_IN,RTEQSQ,AO,COSQ2,SINOMO,COSOMO,
...
*     INITIALIZE LUNAR SOLAR TERMS
    ...
    5 DAY=DS50+18261.5D0
      ...
      PREEP = DAY
      XNODCE=4.5236020-9.2422029D-4*DAY
      STEM=DSIN (XNODCE)
      CTEM=DCOS (XNODCE)
...
C
      ...
      SGH=S4*ZN*(Z31+Z33-6.)
      SH=-ZN*S2*(Z21+Z23)
      IF(XQNCL.LT.5.2359877D-2) SH=0.0
      EE2=2.*S1*S6
      E3=2.*S1*S7
      XI2=2.*S2*Z12
      XI3=2.*S2*(Z13-Z11)
...
*     ENTRANCE FOR DEEP SPACE SECULAR EFFECTS
      ...
      ENTRY DPSEC(XLL,OMGASM,XNODES,EM,XINC,XN,T_IN)
	T = T_IN
      XLL=XLL+SSL*T
      OMGASM=OMGASM+SSG*T
      XNODES=XNODES+SSH*T
